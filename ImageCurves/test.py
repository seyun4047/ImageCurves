...
def transCurve(X, Y, userX, userY):
    ...
    # print(X[xIdx-1], X[xIdx+1])
    # print(Y[X[xIdx-1]], userY, Y[X[xIdx-1]])
...
#-----------------------------------------------------
# test
X, Y, lDotX, rDotX, changedColorList = transCurve(X,curveList,150,170) # X: 150인 값을 170으로 바꿨을 때
curveList = changeCurve(curveList, changedColorList, lDotX, rDotX)

X, Y, lDotX, rDotX, changedColorList = transCurve(X,curveList,100,200) # X: 150인 값을 170으로 바꿨을 때
curveList = changeCurve(curveList, changedColorList, lDotX, rDotX)

X, Y, lDotX, rDotX, changedColorList = transCurve(X,curveList,40,200) # X: 150인 값을 170으로 바꿨을 때
curveList = changeCurve(curveList, changedColorList, lDotX, rDotX)
