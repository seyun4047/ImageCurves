...
def processImg(board, s, e, colorMapped):
...
def reloadImg(ih, iw, oriImg, s, e, board, dims):
...
# board = setImg(ih, iw, oriImg)
# s=0
# e=100
# cM = [0] * 256
# # print(cM)
# changedBoard = processImg(board, s, e, cM)
# print(changedBoard[0])
# reImg = reloadImg(ih, iw, oriImg, s, e, board=changedBoard, dims=1)
